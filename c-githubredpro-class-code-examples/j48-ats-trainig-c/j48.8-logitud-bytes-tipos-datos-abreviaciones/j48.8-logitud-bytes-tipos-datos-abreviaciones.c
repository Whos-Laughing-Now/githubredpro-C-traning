...
/*
	...
	int 			c = 1204; 		// Tamano en byte, Rango = -32.66...32767
	unsigned int 	d = 128; 		// tamano 2 Bytes Rango 0...65535
	long 			e = 123456; 	// Tamano 4 Bytes Rango -2147483648...2147483637
	float  			f = 15.678; 	// Tamano 4 Bytes Rango - 3.4*(10)...3.4*(10)
	double			m = 1.25444; 	// Tamano 8 Bytes Rango  1.7*(10)...1.7*(10) 
...
int main (){ // Funcion principal
		...
		char caractere2 = '48J'; // solo pinta el ultimo caractewre de una cadena
		...
		printf("el elemento m es : %.lf \n",m);	// long double 		(%lf) --> con ( .lf ) convertimos un numero flotante en un numero entero
