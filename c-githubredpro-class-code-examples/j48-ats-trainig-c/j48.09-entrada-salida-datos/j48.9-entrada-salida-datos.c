...
int main (){ // Funcion principal
	...
	char	f = 'e'; 														/* Siempre comillas simples para las operaciones de tipo caractere, 
					    														recuerda que la char solo devuelve el ultimo caractere de una cadena de string */
						    
	// Pinta por pantalla los datos de operacion1
	//	printf("El valoe de int es %i \n el valor de float es %.2f \n el valor d e char es %c \n", a, b, f);
	
		printf("El valor de int es %i \n", a);								// Pinta por pantalla los datos de operacion1
		printf("El valor de float es %.2f \n ", b);							// Pinta por pantalla los datos de operacion1
		printf("El valoe de char es %c \n", f);								// Pinta por pantalla los datos de operacion1
		printf(" \n");														// Salto de linea
	...
	scanf("%i", &d); 														/* lo que hacemos es pedir por pantalla el valor y el tipo (%i) de de la variable (d)
																				y en que posicion de memoria lo vamos guardar (&d) */
	printf("El valor de la variable ( d ) es un numero entero : %i", d);	// Pinta por pantallas el valor de la variable (d) es un numero integer;
	printf(" \n");															// Salto de linea
	printf(" \n");															// Salto de linea
	...
	printf("El valor de la variable ( e ) es un numero flotante %.2f", e);	/* Pinta por pantalla el valor de la variable (e) es un numero flotante %f", e;
